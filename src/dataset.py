...
class GPTDataset(Dataset):
    ...
    def __init__(
        ...
        # 만들 수 있는 학습 샘플(input, target) 쌍 개수를 self.lengh에 저장 
        
        
        self._length = (len(self.token_ids) - self.context_length - 1) // self.stride + 1        # 전체 token_ids에서 만들 수 있는 input/target 샘플 개수 계산
